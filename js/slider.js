...
var slide1 = document.querySelector('.carousel__slide_1');
var slide2 = document.querySelector('.carousel__slide_2');
var slide3 = document.querySelector('.carousel__slide_3');
s1 = {
    name : slide1,
